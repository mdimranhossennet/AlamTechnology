...
export default function FooterV1() {
  ...
  useEffect(() => {
    // Check environment details (standalone mode and iOS detection)
      ...
      <div className="container mx-auto px-4 md:px-0">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5">
          <div className="flex flex-col items-center text-center md:items-start md:text-left gap-4 lg:col-span-2">
            ...
            <p className="text-sm text-muted-foreground w-full md:w-4/5">
              Empowering the next generation with modern education, moral values, and academic excellence. Join us in shaping a brighter future.
            </p>
          ...
          <div className="flex flex-col items-center text-center md:items-start md:text-left md:pt-3">
            ...
            <ul className="grid gap-3 text-sm text-muted-foreground">
              <li className="flex items-start justify-center md:justify-start gap-3">
                ...
                <span>{settings?.contact?.address || '123 HEB Vision International Avenue'}</span>
              </li>
              ...
              <li className="flex items-center justify-center md:justify-start gap-3">
                ...
                <span>{settings?.contact?.email || 'support@HEBVisionInternational.com'}</span>
              </li>
            </ul>
            {hasSocialLinks && (
        ...
        <div className="mt-12 flex flex-col items-center justify-between border-t py-6 sm:flex-row text-sm text-muted-foreground gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <p>© {new Date().getFullYear()} {settings?.brandName || 'HEB Vision International'}. All rights reserved.</p>
          </div>
